...
export const STARTER_CHARACTERS: CharacterDef[] = [
  { id: 'samurai', name: 'SAMURAI', description: 'Balanced warrior with swift blade', stats: { hp: 120, speed: 3.2, damage: 22, magic: 60 }, passive: { id: 'iaido', name: 'Iaido', description: 'First hit after dash deals 2x damage' }, artPaths: { portrait: '/assets/characters/samurai_portrait.webp', sprite: '/assets/characters/samurai_sprite.webp', icon: '/assets/characters/samurai_icon.webp' } },
  { id: 'witch', name: 'WITCH', description: 'High magic caster with hexes', stats: { hp: 65, speed: 2.9, damage: 10, magic: 180 }, passive: { id: 'hex', name: 'Hex', description: 'Spells apply debuff stack, 3 stacks = bonus damage' }, artPaths: { portrait: '/assets/characters/witch_portrait.webp', sprite: '/assets/characters/witch_sprite.webp', icon: '/assets/characters/witch_icon.webp' } },
  { id: 'ninja', name: 'NINJA', description: 'Fast assassin with shadow powers', stats: { hp: 80, speed: 4.2, damage: 20, magic: 50 }, passive: { id: 'shadow_step', name: 'Shadow Step', description: 'Perfect block grants brief invulnerability' }, artPaths: { portrait: '/assets/characters/ninja_portrait.webp', sprite: '/assets/characters/ninja_sprite.webp', icon: '/assets/characters/ninja_icon.webp' } },
  { id: 'paladin', name: 'PALADIN', description: 'Holy knight with protective aura', stats: { hp: 180, speed: 2.6, damage: 18, magic: 70 }, passive: { id: 'divine_shield', name: 'Divine Shield', description: 'Blocking heals nearby allies' }, artPaths: { portrait: '/assets/characters/paladin_portrait.webp', sprite: '/assets/characters/paladin_sprite.webp', icon: '/assets/characters/paladin_icon.webp' } },
  { id: 'necromancer', name: 'NECROMANCER', description: 'Dark mage who commands the dead', stats: { hp: 60, speed: 2.8, damage: 12, magic: 170 }, passive: { id: 'soul_harvest', name: 'Soul Harvest', description: 'Kills spawn temporary ghost ally' }, artPaths: { portrait: '/assets/characters/necromancer_portrait.webp', sprite: '/assets/characters/necromancer_sprite.webp', icon: '/assets/characters/necromancer_icon.webp' } },
  { id: 'bard', name: 'BARD', description: 'Musical support with buffs', stats: { hp: 90, speed: 3.4, damage: 12, magic: 140 }, passive: { id: 'battle_hymn', name: 'Battle Hymn', description: 'Nearby allies gain 15% speed boost' }, artPaths: { portrait: '/assets/characters/bard_portrait.webp', sprite: '/assets/characters/bard_sprite.webp', icon: '/assets/characters/bard_icon.webp' } },
  { id: 'druid', name: 'DRUID', description: 'Nature mage with regeneration', stats: { hp: 75, speed: 3.0, damage: 10, magic: 160 }, passive: { id: 'natures_gift', name: "Nature's Gift", description: 'Regenerate HP while in forest biome' }, artPaths: { portrait: '/assets/characters/druid_portrait.webp', sprite: '/assets/characters/druid_sprite.webp', icon: '/assets/characters/druid_icon.webp' } },
];

export const UNLOCKABLE_CHARACTERS: CharacterDef[] = [
  // Elemental variants (8)
  { id: 'fire_samurai', name: 'FIRE SAMURAI', description: 'Blade wreathed in flames', stats: { hp: 110, speed: 3.3, damage: 26, magic: 55 }, passive: { id: 'fire_aura', name: 'Fire Aura', description: 'Melee attacks burn enemies' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'burn_100', description: 'Burn 100 enemies' }, artPaths: { portrait: '/assets/characters/fire_samurai_portrait.webp', sprite: '/assets/characters/fire_samurai_sprite.webp', icon: '/assets/characters/fire_samurai_icon.webp' } },
  { id: 'ice_witch', name: 'ICE WITCH', description: 'Mistress of frost magic', stats: { hp: 55, speed: 2.7, damage: 8, magic: 200 }, passive: { id: 'frost_armor', name: 'Frost Armor', description: 'Taking damage slows attacker' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'freeze_50', description: 'Freeze 50 enemies' }, artPaths: { portrait: '/assets/characters/ice_witch_portrait.webp', sprite: '/assets/characters/ice_witch_sprite.webp', icon: '/assets/characters/ice_witch_icon.webp' } },
  { id: 'storm_ninja', name: 'STORM NINJA', description: 'Lightning-fast striker', stats: { hp: 75, speed: 4.8, damage: 24, magic: 45 }, passive: { id: 'storm_call', name: 'Storm Call', description: 'Dash leaves lightning trail' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'shock_75', description: 'Shock 75 enemies' }, artPaths: { portrait: '/assets/characters/storm_ninja_portrait.webp', sprite: '/assets/characters/storm_ninja_sprite.webp', icon: '/assets/characters/storm_ninja_icon.webp' } },
  { id: 'shadow_paladin', name: 'SHADOW PALADIN', description: 'Fallen knight of darkness', stats: { hp: 160, speed: 2.7, damage: 20, magic: 65 }, passive: { id: 'shadow_cloak', name: 'Shadow Cloak', description: 'Blocking absorbs damage as mana' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'block_200', description: 'Block 200 attacks' }, artPaths: { portrait: '/assets/characters/shadow_paladin_portrait.webp', sprite: '/assets/characters/shadow_paladin_sprite.webp', icon: '/assets/characters/shadow_paladin_icon.webp' } },
  { id: 'earth_druid', name: 'EARTH DRUID', description: 'Stone and root master', stats: { hp: 70, speed: 2.6, damage: 10, magic: 175 }, passive: { id: 'earth_shield', name: 'Earth Shield', description: 'Standing still grants damage reduction' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'tank_1000', description: 'Take 1000 damage in one run' }, artPaths: { portrait: '/assets/characters/earth_druid_portrait.webp', sprite: '/assets/characters/earth_druid_sprite.webp', icon: '/assets/characters/earth_druid_icon.webp' } },
  { id: 'light_bard', name: 'LIGHT BARD', description: 'Radiant songweaver', stats: { hp: 80, speed: 3.4, damage: 10, magic: 165 }, passive: { id: 'light_burst', name: 'Light Burst', description: 'Healing spells also deal AOE damage' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'heal_500', description: 'Heal 500 HP total' }, artPaths: { portrait: '/assets/characters/light_bard_portrait.webp', sprite: '/assets/characters/light_bard_sprite.webp', icon: '/assets/characters/light_bard_icon.webp' } },
  { id: 'water_necro', name: 'WATER NECROMANCER', description: 'Drowned soul summoner', stats: { hp: 55, speed: 2.9, damage: 12, magic: 185 }, passive: { id: 'water_flow', name: 'Water Flow', description: 'Ghosts slow enemies they pass through' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'summon_30', description: 'Summon 30 ghosts' }, artPaths: { portrait: '/assets/characters/water_necro_portrait.webp', sprite: '/assets/characters/water_necro_sprite.webp', icon: '/assets/characters/water_necro_icon.webp' } },
  { id: 'wind_ninja', name: 'WIND NINJA', description: 'Swift as the gale', stats: { hp: 70, speed: 5.2, damage: 22, magic: 40 }, passive: { id: 'wind_dash', name: 'Wind Dash', description: 'Dash cooldown reduced by 50%' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'dash_100', description: 'Dash 100 times' }, artPaths: { portrait: '/assets/characters/wind_ninja_portrait.webp', sprite: '/assets/characters/wind_ninja_sprite.webp', icon: '/assets/characters/wind_ninja_icon.webp' } },

  // Monster roster (12)
  { id: 'dragon_knight', name: 'DRAGON KNIGHT', description: 'Warrior bonded with a drake', stats: { hp: 200, speed: 2.4, damage: 32, magic: 45 }, passive: { id: 'dragon_blood', name: 'Dragon Blood', description: 'Fire damage heals instead of hurts' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'kill_dragon', description: 'Defeat Dragon Boss' }, artPaths: { portrait: '/assets/characters/dragon_knight_portrait.webp', sprite: '/assets/characters/dragon_knight_sprite.webp', icon: '/assets/characters/dragon_knight_icon.webp' } },
  { id: 'vampire', name: 'VAMPIRE', description: 'Immortal blood drinker', stats: { hp: 85, speed: 3.6, damage: 24, magic: 90 }, passive: { id: 'vampiric', name: 'Vampiric', description: 'Lifesteal on all attacks' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'drain_300', description: 'Drain 300 HP from enemies' }, artPaths: { portrait: '/assets/characters/vampire_portrait.webp', sprite: '/assets/characters/vampire_sprite.webp', icon: '/assets/characters/vampire_icon.webp' } },
  { id: 'werewolf', name: 'WEREWOLF', description: 'Savage beast warrior', stats: { hp: 130, speed: 4.4, damage: 30, magic: 35 }, passive: { id: 'lycanthropy', name: 'Lycanthropy', description: 'Speed and damage increase at low HP' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'low_hp_kills', description: 'Kill 50 enemies below 30% HP' }, artPaths: { portrait: '/assets/characters/werewolf_portrait.webp', sprite: '/assets/characters/werewolf_sprite.webp', icon: '/assets/characters/werewolf_icon.webp' } },
  { id: 'slime', name: 'SLIME', description: 'Bouncy blob creature', stats: { hp: 250, speed: 2.0, damage: 8, magic: 40 }, passive: { id: 'slime_split', name: 'Slime Split', description: 'Taking fatal damage splits into 2 weaker slimes' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'survive_20', description: 'Survive 20 waves' }, artPaths: { portrait: '/assets/characters/slime_portrait.webp', sprite: '/assets/characters/slime_sprite.webp', icon: '/assets/characters/slime_icon.webp' } },
  { id: 'angel', name: 'ANGEL', description: 'Divine messenger', stats: { hp: 70, speed: 3.6, damage: 10, magic: 180 }, passive: { id: 'angelic', name: 'Angelic', description: 'Revive once per run with 50% HP' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'revive_ally', description: 'Revive allies 10 times' }, artPaths: { portrait: '/assets/characters/angel_portrait.webp', sprite: '/assets/characters/angel_sprite.webp', icon: '/assets/characters/angel_icon.webp' } },
  { id: 'demon', name: 'DEMON', description: 'Infernal destroyer', stats: { hp: 140, speed: 3.2, damage: 35, magic: 55 }, passive: { id: 'demonic', name: 'Demonic', description: 'Damage increases with kill streak' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'streak_20', description: 'Get a 20 kill streak' }, artPaths: { portrait: '/assets/characters/demon_portrait.webp', sprite: '/assets/characters/demon_sprite.webp', icon: '/assets/characters/demon_icon.webp' } },
  { id: 'skeleton', name: 'SKELETON', description: 'Undead warrior', stats: { hp: 90, speed: 3.4, damage: 22, magic: 50 }, passive: { id: 'undead', name: 'Undead', description: 'Immune to poison, healing reduced 50%' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'kill_necro', description: 'Defeat 10 Necromancers' }, artPaths: { portrait: '/assets/characters/skeleton_portrait.webp', sprite: '/assets/characters/skeleton_sprite.webp', icon: '/assets/characters/skeleton_icon.webp' } },
  { id: 'ghost_player', name: 'GHOST', description: 'Ethereal specter', stats: { hp: 50, speed: 4.0, damage: 14, magic: 175 }, passive: { id: 'spectral', name: 'Spectral', description: 'Can phase through enemies and walls briefly' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'kill_ghosts', description: 'Kill 100 ghosts' }, artPaths: { portrait: '/assets/characters/ghost_portrait.webp', sprite: '/assets/characters/ghost_sprite.webp', icon: '/assets/characters/ghost_icon.webp' } },
  { id: 'minotaur', name: 'MINOTAUR', description: 'Brutal beast of the labyrinth', stats: { hp: 220, speed: 2.3, damage: 38, magic: 25 }, passive: { id: 'beastial', name: 'Beastial', description: 'Charge attack deals triple damage' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'kill_tanks', description: 'Kill 50 Tank enemies' }, artPaths: { portrait: '/assets/characters/minotaur_portrait.webp', sprite: '/assets/characters/minotaur_sprite.webp', icon: '/assets/characters/minotaur_icon.webp' } },
  { id: 'harpy_player', name: 'HARPY', description: 'Winged predator', stats: { hp: 65, speed: 4.6, damage: 22, magic: 60 }, passive: { id: 'feral', name: 'Feral', description: 'Attacks from above deal bonus damage' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'jump_kills', description: 'Kill 30 enemies while airborne' }, artPaths: { portrait: '/assets/characters/harpy_portrait.webp', sprite: '/assets/characters/harpy_sprite.webp', icon: '/assets/characters/harpy_icon.webp' } },
  { id: 'golem', name: 'GOLEM', description: 'Animated stone construct', stats: { hp: 320, speed: 1.6, damage: 28, magic: 20 }, passive: { id: 'ancient', name: 'Ancient', description: 'Immune to knockback' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'build_walls', description: 'Build 50 wall segments' }, artPaths: { portrait: '/assets/characters/golem_portrait.webp', sprite: '/assets/characters/golem_sprite.webp', icon: '/assets/characters/golem_icon.webp' } },
  { id: 'lich', name: 'LICH', description: 'Undead archmage', stats: { hp: 50, speed: 2.5, damage: 12, magic: 220 }, passive: { id: 'corrupted', name: 'Corrupted', description: 'Spells cost HP instead of mana' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'cast_200', description: 'Cast 200 spells' }, artPaths: { portrait: '/assets/characters/lich_portrait.webp', sprite: '/assets/characters/lich_sprite.webp', icon: '/assets/characters/lich_icon.webp' } },

  // Class variants (10)
  { id: 'dark_paladin', name: 'DARK PALADIN', description: 'Corrupted holy knight', stats: { hp: 170, speed: 2.8, damage: 24, magic: 60 }, passive: { id: 'dark_pact', name: 'Dark Pact', description: 'Sacrifice HP to boost damage temporarily' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'play_paladin', description: 'Complete 10 runs as Paladin' }, artPaths: { portrait: '/assets/characters/dark_paladin_portrait.webp', sprite: '/assets/characters/dark_paladin_sprite.webp', icon: '/assets/characters/dark_paladin_icon.webp' } },
  { id: 'blood_necro', name: 'BLOOD NECROMANCER', description: 'Life magic corruptor', stats: { hp: 60, speed: 2.9, damage: 14, magic: 190 }, passive: { id: 'blood_magic', name: 'Blood Magic', description: 'Ghosts explode on death dealing AOE' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'play_necro', description: 'Complete 10 runs as Necromancer' }, artPaths: { portrait: '/assets/characters/blood_necro_portrait.webp', sprite: '/assets/characters/blood_necro_sprite.webp', icon: '/assets/characters/blood_necro_icon.webp' } },
  { id: 'war_bard', name: 'WAR BARD', description: 'Battle-hardened musician', stats: { hp: 130, speed: 3.0, damage: 20, magic: 80 }, passive: { id: 'war_cry', name: 'War Cry', description: 'Nearby allies deal 20% more damage' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'play_bard', description: 'Complete 10 runs as Bard' }, artPaths: { portrait: '/assets/characters/war_bard_portrait.webp', sprite: '/assets/characters/war_bard_sprite.webp', icon: '/assets/characters/war_bard_icon.webp' } },
  { id: 'shadow_ninja', name: 'SHADOW NINJA', description: 'Master of stealth', stats: { hp: 70, speed: 4.5, damage: 28, magic: 45 }, passive: { id: 'shadow_dance', name: 'Shadow Dance', description: 'Become invisible briefly after killing' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'play_ninja', description: 'Complete 10 runs as Ninja' }, artPaths: { portrait: '/assets/characters/shadow_ninja_portrait.webp', sprite: '/assets/characters/shadow_ninja_sprite.webp', icon: '/assets/characters/shadow_ninja_icon.webp' } },
  { id: 'holy_druid', name: 'HOLY DRUID', description: 'Light-blessed nature mage', stats: { hp: 65, speed: 3.1, damage: 10, magic: 185 }, passive: { id: 'holy_light', name: 'Holy Light', description: 'Healing creates light damage zone' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'play_druid', description: 'Complete 10 runs as Druid' }, artPaths: { portrait: '/assets/characters/holy_druid_portrait.webp', sprite: '/assets/characters/holy_druid_sprite.webp', icon: '/assets/characters/holy_druid_icon.webp' } },
  { id: 'plague_witch', name: 'PLAGUE WITCH', description: 'Mistress of disease', stats: { hp: 55, speed: 2.8, damage: 10, magic: 195 }, passive: { id: 'plague', name: 'Plague', description: 'Debuffs spread to nearby enemies' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'play_witch', description: 'Complete 10 runs as Witch' }, artPaths: { portrait: '/assets/characters/plague_witch_portrait.webp', sprite: '/assets/characters/plague_witch_sprite.webp', icon: '/assets/characters/plague_witch_icon.webp' } },
  { id: 'arcane_samurai', name: 'ARCANE SAMURAI', description: 'Magic-infused swordmaster', stats: { hp: 100, speed: 3.3, damage: 22, magic: 100 }, passive: { id: 'arcane_surge', name: 'Arcane Surge', description: 'Melee kills restore mana' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'play_samurai', description: 'Complete 10 runs as Samurai' }, artPaths: { portrait: '/assets/characters/arcane_samurai_portrait.webp', sprite: '/assets/characters/arcane_samurai_sprite.webp', icon: '/assets/characters/arcane_samurai_icon.webp' } },
  { id: 'wild_druid', name: 'WILD DRUID', description: 'Feral shapeshifter', stats: { hp: 110, speed: 3.8, damage: 20, magic: 90 }, passive: { id: 'wild_growth', name: 'Wild Growth', description: 'Gain stacking speed in forests' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'forest_time', description: 'Spend 10 minutes in forests' }, artPaths: { portrait: '/assets/characters/wild_druid_portrait.webp', sprite: '/assets/characters/wild_druid_sprite.webp', icon: '/assets/characters/wild_druid_icon.webp' } },
  { id: 'stone_paladin', name: 'STONE PALADIN', description: 'Immovable defender', stats: { hp: 240, speed: 2.0, damage: 22, magic: 50 }, passive: { id: 'stone_skin', name: 'Stone Skin', description: 'Take 25% less damage while blocking' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'perfect_blocks', description: 'Perfect block 100 times' }, artPaths: { portrait: '/assets/characters/stone_paladin_portrait.webp', sprite: '/assets/characters/stone_paladin_sprite.webp', icon: '/assets/characters/stone_paladin_icon.webp' } },
  { id: 'blade_dancer', name: 'BLADE DANCER', description: 'Graceful dual wielder', stats: { hp: 85, speed: 4.0, damage: 30, magic: 45 }, passive: { id: 'blade_dance', name: 'Blade Dance', description: 'Attack speed increases with consecutive hits' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'melee_500', description: 'Kill 500 enemies with melee' }, artPaths: { portrait: '/assets/characters/blade_dancer_portrait.webp', sprite: '/assets/characters/blade_dancer_sprite.webp', icon: '/assets/characters/blade_dancer_icon.webp' } },

  // Joke characters (5)
  { id: 'chef', name: 'CHEF', description: 'Culinary combatant', stats: { hp: 120, speed: 2.9, damage: 18, magic: 70 }, passive: { id: 'chef_special', name: 'Chef Special', description: 'Potions heal 50% more' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'use_potions', description: 'Use 50 potions' }, artPaths: { portrait: '/assets/characters/chef_portrait.webp', sprite: '/assets/characters/chef_sprite.webp', icon: '/assets/characters/chef_icon.webp' } },
  { id: 'mime', name: 'MIME', description: 'Silent performer', stats: { hp: 70, speed: 3.4, damage: 10, magic: 150 }, passive: { id: 'mime_trick', name: 'Mime Trick', description: 'Invisible walls block projectiles briefly' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'dodge_100', description: 'Dodge 100 projectiles' }, artPaths: { portrait: '/assets/characters/mime_portrait.webp', sprite: '/assets/characters/mime_sprite.webp', icon: '/assets/characters/mime_icon.webp' } },
  { id: 'merchant', name: 'MERCHANT', description: 'Gold-obsessed trader', stats: { hp: 100, speed: 3.0, damage: 12, magic: 100 }, passive: { id: 'merchant_luck', name: 'Merchant Luck', description: 'Enemies drop 50% more gold' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'collect_gold', description: 'Collect 10000 gold total' }, artPaths: { portrait: '/assets/characters/merchant_portrait.webp', sprite: '/assets/characters/merchant_sprite.webp', icon: '/assets/characters/merchant_icon.webp' } },
  { id: 'scarecrow', name: 'SCARECROW', description: 'Animated field guardian', stats: { hp: 80, speed: 2.7, damage: 16, magic: 110 }, passive: { id: 'scarecrow_fear', name: 'Scarecrow Fear', description: 'Weak enemies flee from you' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'scare_enemies', description: 'Make 200 enemies flee' }, artPaths: { portrait: '/assets/characters/scarecrow_portrait.webp', sprite: '/assets/characters/scarecrow_sprite.webp', icon: '/assets/characters/scarecrow_icon.webp' } },
  { id: 'chicken', name: 'CHICKEN', description: 'Surprisingly fierce fowl', stats: { hp: 35, speed: 4.8, damage: 40, magic: 20 }, passive: { id: 'chicken_rage', name: 'Chicken Rage', description: 'Glass cannon - huge damage, low HP' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'no_hit_wave', description: 'Complete a wave without taking damage' }, artPaths: { portrait: '/assets/characters/chicken_portrait.webp', sprite: '/assets/characters/chicken_sprite.webp', icon: '/assets/characters/chicken_icon.webp' } },

  // Legendaries (5)
  { id: 'phoenix', name: 'PHOENIX', description: 'Eternal fire bird', stats: { hp: 90, speed: 3.8, damage: 14, magic: 180 }, passive: { id: 'phoenix_rebirth', name: 'Phoenix Rebirth', description: 'Revive at full HP once, then explode on death' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'beat_boss_drake', description: 'Defeat Boss Drake' }, artPaths: { portrait: '/assets/characters/phoenix_portrait.webp', sprite: '/assets/characters/phoenix_sprite.webp', icon: '/assets/characters/phoenix_icon.webp' } },
  { id: 'titan', name: 'TITAN', description: 'Ancient giant', stats: { hp: 400, speed: 1.4, damage: 45, magic: 30 }, passive: { id: 'titan_strength', name: 'Titan Strength', description: 'Melee attacks create shockwaves' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'reach_wave_30', description: 'Reach wave 30' }, artPaths: { portrait: '/assets/characters/titan_portrait.webp', sprite: '/assets/characters/titan_sprite.webp', icon: '/assets/characters/titan_icon.webp' } },
  { id: 'void_walker', name: 'VOID WALKER', description: 'Between dimensions', stats: { hp: 60, speed: 3.4, damage: 12, magic: 210 }, passive: { id: 'void_walk', name: 'Void Walk', description: 'Teleport leaves damaging rift' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'teleport_50', description: 'Use teleport 50 times' }, artPaths: { portrait: '/assets/characters/void_walker_portrait.webp', sprite: '/assets/characters/void_walker_sprite.webp', icon: '/assets/characters/void_walker_icon.webp' } },
  { id: 'time_keeper', name: 'TIME KEEPER', description: 'Master of temporal magic', stats: { hp: 65, speed: 3.2, damage: 10, magic: 220 }, passive: { id: 'time_warp', name: 'Time Warp', description: 'All cooldowns reduced by 20%' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'use_time_slow', description: 'Use Time Slow spell 25 times' }, artPaths: { portrait: '/assets/characters/time_keeper_portrait.webp', sprite: '/assets/characters/time_keeper_sprite.webp', icon: '/assets/characters/time_keeper_icon.webp' } },
  { id: 'world_eater', name: 'WORLD EATER', description: 'Cosmic devourer', stats: { hp: 200, speed: 2.6, damage: 50, magic: 80 }, passive: { id: 'world_eater', name: 'World Eater', description: 'Killing bosses permanently increases all stats' }, unlockCondition: { type: 'CHALLENGE', challengeId: 'kill_all_bosses', description: 'Defeat every boss type' }, artPaths: { portrait: '/assets/characters/world_eater_portrait.webp', sprite: '/assets/characters/world_eater_sprite.webp', icon: '/assets/characters/world_eater_icon.webp' } },
];
