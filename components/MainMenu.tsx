    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/60 backdrop-blur-xl z-50 p-6">
      <div className="max-w-3xl w-full text-center p-12 bg-white/5 rounded-[3rem] border border-white/10 shadow-[0_0_80px_rgba(0,0,0,0.5)]">
        ...
        <p className="text-yellow-400/60 mb-12 text-sm tracking-[0.5em] uppercase font-bold">
          Ancient Soul Connection Active
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          ...
          >
            ...
            <div className="text-[10px] text-white/30 mt-3 uppercase tracking-widest font-mono">WASD + E/F + SHIFT + SPACE</div>
          </button>
          ...
          >
            ...
            <div className="text-[10px] text-white/30 mt-3 uppercase tracking-widest font-mono">STICKS + R2/L2 + A + X</div>
          </button>
        </div>
        ...
        <div className="space-y-4 text-left p-8 bg-black/40 rounded-3xl border border-white/5 backdrop-blur-md">
          <div className="grid grid-cols-2 gap-8">
            <div className="text-[11px] text-white/40 space-y-3">
              <div className="flex justify-between border-b border-white/5 pb-1"><span className="text-white/80 font-mono">SPELL (R2)</span> <span className="text-purple-400">E / 0</span></div>
              <div className="flex justify-between border-b border-white/5 pb-1"><span className="text-white/80 font-mono">PARRY (L2)</span> <span className="text-blue-400">SHIFT</span></div>
              <div className="flex justify-between border-b border-white/5 pb-1"><span className="text-white/80 font-mono">JUMP (A)</span> <span className="text-green-400">SPACE</span></div>
              <div className="flex justify-between border-b border-white/5 pb-1"><span className="text-white/80 font-mono">MOUNT (X)</span> <span className="text-yellow-400">R / ENTER</span></div>
            </div>
            <div className="text-[11px] text-white/40 space-y-2 border-l border-white/10 pl-8 flex flex-col justify-center">
              ...
              <div><span className="text-red-500 font-bold">RESCUE:</span> Hold Action near fallen allies.</div>
